  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      ...
      <div className="dark:bg-dark-card p-4">
        ...
        <h3 className="text-dark-heading dark:text-light-heading font-medium pt-4 flex flex-wrap">
          Tech Stack :&nbsp; <span className="font-light">{techstack}</span>
        </h3>
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            <svg
              className="stroke-dark-heading dark:stroke-black inline-block min-w-fit"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
            ...
            <a
              ...
              className=" pl-2 font-light dark:text-black"
            >
              Live Preview
            </a>
          </div>
