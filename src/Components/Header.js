  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/" className="text-gradient font-medium">
          <i class="fa-solid fa-d text-4xl"></i>&nbsp;
          <i class="fa-solid fa-m text-4xl"></i>
        </NavLink>
        ...
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <li>
            <a
              ...
              className="text-sm font-medium text-white bg-blue-600 px-4 py-2 rounded hover:bg-blue-900 "
              onClick={toggleClass}
            >
